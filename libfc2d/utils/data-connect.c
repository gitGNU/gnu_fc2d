...
void
f_data_connect (gpointer obj, const char* name,
                gpointer data)
{
...
void
f_data_disconnect (gpointer obj, const char* name)
{
  GHashTable** hash = &f_dataconnect_hash;
  GHashTable* h = NULL;
...
gpointer
f_data_get (gpointer obj, const char* name)
{
  GHashTable** hash = &f_dataconnect_hash;
  GHashTable* h = NULL;
  gpointer ret;
...
gpointer*
f_data_get_pointer (gpointer obj,
